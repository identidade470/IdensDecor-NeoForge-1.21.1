    ...
    static void addItems() {
        ...
        FancyTabSections.addSection(IdenDecorMod.rl("base"),
                new SectionTextured(IdenDecorMod.rl("facility_blocks"))
                        ...
                        .add(ModBlocks.INDUSTRIAL_RED_LAMP)
                        ...
                        .add(ModBlocks.RED_SLIM_METAL_GAS_CYLINDER)
                        .add(ModBlocks.RED_METAL_GAS_CYLINDER)
                        .add(ModBlocks.RED_WIDE_METAL_GAS_CYLINDER)
        ...
        FancyTabSections.addSection(IdenDecorMod.rl("base"),
                new SectionTextured(IdenDecorMod.rl("urban_blocks"))
                        .setItems(urban)
        );
        ...
        FancyTabSections.addSection(IdenDecorMod.rl("base"),
                new SectionTextured(IdenDecorMod.rl("colored_wood"))
                        .setItems(coloredPlanks)
        );
    }
